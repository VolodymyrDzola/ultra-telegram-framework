...
* **🛡 Строга типізація:** Автоматична генерація типів на основі офіційної специфікації.
...
[git clone https://github.com/ваш-нік/ultra-tg-framework.git](https://github.com/VolodymyrDzola/tg-framework.git)
cd tg-framework
npm install
